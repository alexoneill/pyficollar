...
def main() -> None:
    ...
    dev = client.enable_lost_dog_mode(pet_id)
    print(f"   -> Lost Dog Mode activated for pet {pet_id}! (Device: {dev.module_id})")
    dev = client.disable_lost_dog_mode(pet_id)
    print(f"   -> Lost Dog Mode deactivated!")
